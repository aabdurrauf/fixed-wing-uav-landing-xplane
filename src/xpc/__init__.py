...
class XPlaneConnect(object):
    ...
    def clearBuffer(self):
        try:
            ...
            # print("data left in buffer: ", data_in_buffer, "\n")
    ...
    def getCTRL(self, ac=0):
        ...
        resultBuf = self.readUDP()
        if len(resultBuf) != 31:
            print("Unexpected response length:", len(resultBuf), "(should be 31) (this is inside the xpc init file)")
            raise ValueError("Unexpected response length.")
